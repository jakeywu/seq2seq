...
tf.flags.DEFINE_integer("num_units", 10, "Network size")
...
tf.flags.DEFINE_integer("embedding_size", 32, "dimension of vocab")
tf.flags.DEFINE_integer("batch_size", 20, "sentence number of each sequence")
tf.flags.DEFINE_integer("epoch", 1, "epoch size")
